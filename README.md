...
Este repositório está dividido em duas pastas principais para facilitar a localização dos arquivos de customização e dos recursos visuais do terminal. Abaixo você encontra a explicação do que há em cada uma delas:
...
1. Explore a pasta `/Config fastfetch` para clonar o layout das informações do sistema.
2. Acesse a pasta `/creating a terminal icon` para escolher as cores e os símbolos que vão decorar o seu prompt de comando diário.
